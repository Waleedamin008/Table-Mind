...
export default function HomeScreen() {
  ...
  const screens = [
    ...
    { id: 'kds', icon: <ChefHat size={22} />, label: 'Kitchen Display', desc: 'Live order flow from New → Preparing → Ready', color: '#C07830', bg: '#FBF0E0' },
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: 48, animation: 'fadeIn 0.5s ease' }}>
        ...
        <p style={{ fontSize: 16, color: 'var(--text-secondary)', maxWidth: 520, margin: '0 auto 8px' }}>
          The complete restaurant management system built for Ghana — from QR ordering to kitchen display to owner analytics.
        </p>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontSize: 12, color: 'var(--text-muted)', fontWeight: 500 }}>
        ...
        {screens.map((s, i) => (
          <button
            ...
            style={{
              ...
              padding: '24px 20px', cursor: 'pointer', textAlign: 'left', fontFamily: 'var(--font-body)',
